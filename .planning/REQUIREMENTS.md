...
- [ ] **INFRA-01**: Worker accepts audio input via URL download or base64 encoding
- [ ] **INFRA-02**: Worker template provides generalized model download utility (adapted from llama.cpp worker's download_model.py)
